# -*- coding: utf-8 -*-
"""
Created on Thu Aug  1 21:36:10 2024
...
stan_dur = (log_dur - m_dur) / std_dur
...
metrics4 = np.sqrt(np.square(stan_egw) + np.square(stan_freq) + np.square(stan_dur) + np.square(stan_mass))
metrics5 = np.sqrt(np.square(stan_egw) + np.square(stan_freq) + np.square(stan_dur) + np.square(stan_mass) + np.square(stan_vel))
...
for x, y in zip(enumerate(dur_yn), enumerate(rotate_list)):
    ...
    if dur_yn[i] == True and rotate_list[j] == True:
        metrics4_y.append(metrics4[j])
        metrics5_y.append(metrics5[j])
        ...
        metrics4_n.append(metrics4[j])
        metrics5_n.append(metrics5[j])
...
'''
###############################################################################
Plots using 5 parameters log
###############################################################################
'''

print('5 parameter standardization using log')
# Standardized Hyperparameter Coordinates of Energy, Frequency, Duration, Mass, and Angular Velocity vs. Distance
plt.figure()
plt.plot(eff10_y, metrics5_y, 'r*', label = '10% & rotating')
plt.plot(eff10_n, metrics5_n, 'ro', label = '10% & nonrotating')
plt.plot(eff50_y, metrics5_y, 'b*', label = '50% & rotating')
plt.plot(eff50_n, metrics5_n, 'bo', label = '50% & nonrotating')
plt.legend()
plt.title('Standardized 5 parameter Space vs. Distance')
plt.xlabel('Distance (kpc)')
plt.ylabel('Standardized Hyperparameter Coordinates')
plt.grid(True)
plt.xscale('log')
...
# Standardized Hyperparameter Coordinates of Energy, Frequency, Duration, Mass, and Angular Velocity vs. Distance at 10% efficiency
plt.figure()
plt.plot(eff10_y, metrics5_y, 'ro', label = 'rotating')
plt.plot(eff10_n, metrics5_n, 'bo', label = 'nonrotating')
plt.legend()
plt.title('Standardized 5 parameter Space vs. Distance (10% efficiency)')
plt.xlabel('Distance (kpc)')
plt.ylabel('Standardized Hyperparameter Coordinates')
plt.grid(True)
plt.xscale('log')
...
# Standardized Hyperparameter Coordinates of Energy, Frequency, Duration, Mass, and Angular Velocity vs. Distance at 50% efficiency
plt.figure()
plt.plot(eff50_y, metrics5_y, 'ro', label = 'rotating')
plt.plot(eff50_n, metrics5_n, 'bo', label = 'nonrotating')
plt.legend()
plt.title('Standardized 5 parameter Space vs. Distance (50% efficiency)')
plt.xlabel('Distance (kpc)')
plt.ylabel('Standardized Hyperparameter Coordinates')
plt.grid(True)
plt.xscale('log')
...
# Standardized Hyperparameter Coordinates of Energy, Frequency, Duration, Mass, and Angular Velocity vs. Distance only rotating
plt.figure()
plt.plot(eff10_y, metrics5_y, 'ro', label = '10%')
plt.plot(eff50_y, metrics5_y, 'bo', label = '50%')
plt.legend()
plt.title('Standardized  5 parameter Space (rotating) vs. Distance')
plt.xlabel('Distance (kpc)')
plt.ylabel('Standardized Hyperparameter Coordinates')
plt.grid(True)
plt.xscale('log')
